...
const SMMPanels = ()=>{
    ...
    return(<div className="flex dashboard flex-col gap-5">
        <div className="">
            <h2>Your SMM Panels</h2>
            <p>Access a complete list of all your connected SMM panels.</p>
        ...
        {loading ? <Loading/> :<div className="flex flex-col gap-4">
            {data.length>0 ? data.map((e,idx)=>{
                return <div key={`Services_OrderSMM_${e.translations?.en?.name}_${idx}`} className="card p-4 flex justify-between items-center">
                    <div className="flex items-center gap-2">
                        ...
                        <div>
                            ...
                            <p>Status : <strong>{e.price}</strong></p>
                            <p>Services : <strong>{e.services_count}</strong></p>
                            <p>Created at : <strong>{format(new Date(e.created_at), "MMMM d, yyyy")}</strong></p>
                        </div>
                    </div>
        ...
        <Pagination returnedPageNumber={(res)=>{
            setCurrentPage(res)
            getData(null, res)
