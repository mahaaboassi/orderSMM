const SearchInput = ()=>{
    const search_icon = <svg xmlns="http://www.w3.org/2000/svg" width="29" height="29" viewBox="0 0 39 39" fill="none">
            ...
            <path d="M16.7143 32.0357C25.1761 32.0357 32.0357 25.1761 32.0357 16.7143C32.0357 8.25245 25.1761 1.39282 16.7143 1.39282C8.25245 1.39282 1.39282 8.25245 1.39282 16.7143C1.39282 25.1761 8.25245 32.0357 16.7143 32.0357Z" stroke="#08392B" stroke-linecap="round" stroke-linejoin="round"/>
    ...
    return(<div className="input-search w-full">
                ...
                <input className="w-full" placeholder="follower Tiktok" />
