...
const PopupCalled = ({open,children,close,type})=>{
    ...
    return( <div className={`popup ${type == "error"? "err-msg" : ""}`}>
        <div style={{maxHeight: `${window.innerHeight -200}px`}} className='content-popup p-2 flex flex-col gap-2'>
            <div className='flex justify-end cursor-pointer ' onClick={close}>{closeIcon}</div>
