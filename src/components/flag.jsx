...
const Flag = ()=>{
    ...
    return( currectLanguage && "flag" in currectLanguage && <div ref={menuRef} className={`flag-container ${ (i18n.language == "ar" || i18n.language == "ur")? "border-left":"border-right"} `}>
             <div onClick={()=>setIsOpen(!isOpen)}  className="flex items-center gap-2 cursor-pointer">
                <span>{currectLanguage.lng}</span>
