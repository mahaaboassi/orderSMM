...
const Notifications = ()=>{
    ...
    const getData = async(signal, page = 1)=>{
        ...
        if(response){
            if(finalObj.id != response.data[0].id && "id" in finalObj) setIsNew(true)
            setData(response.data)
            setLoading(false)
            setFinalObj(response.data[0])
    ...
    return(<div ref={menuRef} className="relative flag-container">
        ...
        {isOpen && <div className={`notification-menu p-3 flex flex-col gap-2 ${(i18n.language == "ar" || i18n.language == "ur")?" -left-20 xs:left-0":"-right-20 xs:right-0"}`}>
