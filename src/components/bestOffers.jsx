...
const OffersProviders = ()=>{
    ...
    return(<div className="h-full">
        ...
        <div className="h-full">
            {
            !isServicesShow ? <div className="h-full">
                <div>
            ...
            <div className="px-1 md:px-5 pt-5">
                <div className="flex justify-between">
                    <div><img src={currentData.img} alt={currentData.panel} /></div>
